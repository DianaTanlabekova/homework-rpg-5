...
public class Main {
    public static void main(String[] args) {
        ...
        HeroProfile hero = new HeroProfile("Raiden", 100);
        BossEnemy boss = new BossEnemy("Big Dragon", 120, 15);
        ...
        System.out.println("Fire action: " + fireOnly.getActionName());
        System.out.println("Fire damage: " + fireOnly.getDamage());
        System.out.println("Fire effects: " + fireOnly.getEffectSummary());

        System.out.println();

        System.out.println("Poison action: " + poisonOnly.getActionName());
        System.out.println("Poison damage: " + poisonOnly.getDamage());
        System.out.println("Poison effects: " + poisonOnly.getEffectSummary());
